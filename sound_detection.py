...
def sound_main(activate_camera_callback):
    # Initialize PyAudio
    try:
    ...
    last_fifteen_seconds = deque(maxlen=5)
                ...
                try:
                    ...
                    if audio:
                        ...
                        if should_trigger_alarm(last_fifteen_seconds):
                            ...
                            activate_camera_callback()
                            requests.get(
                                'https://bernhackt23-backend.web01.dalcloud.net/api/rasp/alarm/z76tuhgb6z7tuhg76zu8th')
